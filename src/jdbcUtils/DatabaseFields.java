...
public class DatabaseFields {
	...
	public static String yyyy年MM月dd日_HH时mm分ss秒_E = "yyyy年MM月dd日 HH时mm分ss秒 E";
	 ...
	 */
	@Test
	public static void testEump(String[] args) {
	 ...
	 * 			 
	 */
	public static String refFormatNowDate(long time,String format) {
...
//		String date = DatabaseFields.refFormatNowDate(getTime(), yyyy_MM_dd);
//////		String date = DatabaseFields.refFormatNowDate(getTime(), yyyyMMdd);
////		String date = DatabaseFields.refFormatNowDate(getTime(), yyyy年MM月dd日_HH时mm分ss秒_E);
